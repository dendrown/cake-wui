...
A [re-frame](https://github.com/day8/re-frame) game front-end to encourage conversation on complex issues.
...
* [`src/clj/cake_wui/`](src/clj/cake_wui/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/cake_wui/`](src/cljs/cake_wui/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/cake_wui/core.cljs): contains the SPA entry point, `init`
* [`test/cljs/cake_wui/`](test/cljs/cake_wui/): test files (ClojureScript,
...
(headless test environment)
    * For Chromium, set the `CHROME_BIN` environment variable in your shell to the command that
    launches Chromium. For example, in Ubuntu, add the following line to your `.bashrc`:
       ...
       ```
7. Clone this repo and open a terminal in the `cake-wui` project root directory
...
in the [`src/clj/cake_wui/`](src/clj/cake_wui/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/cake_wui/config.cljs) defaults to `true` in
...
```clj
(ns cake-wui.example
  (:require [cake-wui.config :as config])
